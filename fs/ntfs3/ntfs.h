...
/* Verify SECTOR_SHIFT == 9 at compile time (runtime check for older kernels) */
#define __ntfs_verify_sector_shift() do { \
	extern void __compiletime_assert_9(void); \
	BUILD_BUG_ON_MSG(SECTOR_SHIFT != 9, "SECTOR_SHIFT must be 9"); \
} while (0)
...
#define ntfs_static_assert(x) _Static_assert(x, #x)
...
ntfs_static_assert(sizeof(enum FILE_ATTRIBUTE) == 4);
...
ntfs_static_assert(sizeof(__le64) == sizeof(struct MFT_REF));
...
ntfs_static_assert(sizeof(struct NTFS_BOOT) == 0x200);
...
ntfs_static_assert(sizeof(enum NTFS_SIGNATURE) == 4);
...
ntfs_static_assert(sizeof(struct NTFS_RECORD_HEADER) == 0x10);
...
ntfs_static_assert(MFTRECORD_FIXUP_OFFSET_1 == 0x2A);
ntfs_static_assert(MFTRECORD_FIXUP_OFFSET_3 == 0x30);
...
ntfs_static_assert(sizeof(struct ATTRIB) == 0x48);
ntfs_static_assert(sizeof(((struct ATTRIB *)NULL)->res) == 0x08);
ntfs_static_assert(sizeof(((struct ATTRIB *)NULL)->nres) == 0x38);
...
ntfs_static_assert(sizeof(struct ATTR_STD_INFO) == 0x30);
...
ntfs_static_assert(sizeof(struct ATTR_STD_INFO5) == 0x48);
...
ntfs_static_assert(sizeof(struct ATTR_LIST_ENTRY) == 0x20);
...
ntfs_static_assert(sizeof(((struct ATTR_FILE_NAME *)NULL)->dup) == 0x38);
ntfs_static_assert(offsetof(struct ATTR_FILE_NAME, name) == 0x42);
...
ntfs_static_assert(sizeof(struct NTFS_DE) == 0x10);
...
ntfs_static_assert(sizeof(struct INDEX_HDR) == 0x10);
...
ntfs_static_assert(sizeof(struct INDEX_BUFFER) == 0x28);
...
ntfs_static_assert(sizeof(enum COLLATION_RULE) == 4);
...
ntfs_static_assert(sizeof(struct INDEX_ROOT) == 0x20);
ntfs_static_assert(offsetof(struct INDEX_ROOT, ihdr) == 0x10);
...
ntfs_static_assert(sizeof(struct ATTR_DEF_ENTRY) == 0xa0);
...
ntfs_static_assert(sizeof(struct OBJECT_ID) == 0x40);
...
ntfs_static_assert(sizeof(struct NTFS_DE_O) == 0x58);
...
ntfs_static_assert(offsetof(struct REPARSE_KEY, ref) == 0x04);
...
ntfs_static_assert(sizeof(struct NTFS_DE_R) == 0x20);
...
ntfs_static_assert(sizeof(struct REPARSE_POINT) == 0x18);
...
ntfs_static_assert(sizeof(struct EA_INFO) == 8);
...
ntfs_static_assert(offsetof(struct EA_FULL, name) == 8);
...
ntfs_static_assert(sizeof(struct SECURITY_DESCRIPTOR_RELATIVE) == 0x14);
...
ntfs_static_assert(sizeof(struct ACE_HEADER) == 4);
...
ntfs_static_assert(sizeof(struct ACL) == 8);
...
ntfs_static_assert(offsetof(struct SID, SubAuthority) == 8);
