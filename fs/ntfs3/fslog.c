...
ntfs_static_assert(sizeof(struct CLIENT_REC) == 0x60);
...
ntfs_static_assert(sizeof(struct LOG_REC_HDR) == 0x20);
...
ntfs_static_assert(sizeof(struct RESTART_TABLE) == 0x18);
...
// ntfs_static_assert( 0x2C == sizeof(struct OPEN_ATTR_ENRTY_32) );
ntfs_static_assert(sizeof(struct OPEN_ATTR_ENRTY) < SIZEOF_OPENATTRIBUTEENTRY0);
...
ntfs_static_assert(sizeof(struct DIR_PAGE_ENTRY) == 0x20);
...
ntfs_static_assert(offsetof(struct DIR_PAGE_ENTRY_32, vcn_low) == 0x14);
ntfs_static_assert(sizeof(struct DIR_PAGE_ENTRY_32) == 0x2c);
...
ntfs_static_assert(sizeof(struct TRANSACTION_ENTRY) == 0x28);
...
ntfs_static_assert(sizeof(struct NTFS_RESTART) == 0x40);
...
ntfs_static_assert(sizeof(struct LFS_RECORD_HDR) == 0x30);
...
ntfs_static_assert(sizeof(struct LFS_RECORD) == 0x10);
...
ntfs_static_assert(offsetof(struct RECORD_PAGE_HDR, file_off) == 0x3c);
