		       ...
		       struct ntfs_inode *ni, struct mft_inode **mi)
{
	...
	ntfs_static_assert(sizeof(sbi->mft.reserved_bitmap) * 8 >=
...
ntfs_static_assert(sizeof(s_default_security) == 0x50);
			 ...
			 u32 size_sd, __le32 *security_id, bool *inserted)
{
	...
	ntfs_static_assert((1 << Log2OfSecurityDescriptorsBlockSize) ==
