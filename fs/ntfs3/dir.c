		      ...
		      u8 *buf, int buf_len)
{
	...
	ntfs_static_assert(sizeof(wchar_t) == sizeof(__le16));
...
{
	ntfs_static_assert(sizeof(wchar_t) == sizeof(__le16));
	ntfs_static_assert(sizeof(wchar_t) == sizeof(__be16));
		      ...
		      enum utf16_endian endian)
{
	...
	ntfs_static_assert(sizeof(wchar_t) == sizeof(u16));
...
static int ntfs_readdir(struct file *file, struct dir_context *ctx)
{
	...
	ntfs_static_assert(NTFS_NAME_LEN * 4 < PATH_MAX);
